...
class StellaratorData(PROCESSModelData):
    ...
    r_coil_minor: Parameter[float] = 0.0
    """Coil minor radius (m)"""

    r_coil_major: Parameter[float] = 0.0
    """Coil major radius (m)"""
