...
class TimesData(PROCESSModelData):
    ...
    t_plant_pulse_plasma_present: Parameter[float] = 0.0
    """Plant pulse time in which a plasma is present (s)"""

    t_plant_pulse_plasma_current_ramp_down: Parameter[float] = 15.0
    ...
    t_plant_pulse_coil_precharge: Parameter[float] = 15.0
